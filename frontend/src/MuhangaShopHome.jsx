...
function CategoryPill({ cat }) {
  ...
  return (
    ...
    >
      <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center group-hover:bg-emerald-800 transition-colors">
        <Icon className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-800 group-hover:text-white transition-colors" strokeWidth={1.75} />
      </div>
...
function ProductRow({ title, subtitle, items, seeAllCategory, loading }) {
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 sm:px-5 py-4">
      <div className="flex items-center justify-between mb-4 sm:mb-5">
        <div>
          <h2 className="font-serif text-lg sm:text-xl font-semibold text-stone-900 mb-0.5 sm:mb-1">{title}</h2>
          <p className="text-xs sm:text-sm text-stone-400">{subtitle}</p>
        </div>
        <Link
          to={seeAllCategory ? `/products?category=${encodeURIComponent(seeAllCategory)}` : "/products"}
          className="text-sm text-emerald-900 font-medium shrink-0 ml-3"
        >
          See all →
        </Link>
      </div>
...
export default function MuhangaShopHome() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 font-sans">
      ...
      {/* Hero */}
      <section className="max-w-6xl mx-auto px-4 sm:px-5 pt-7 sm:pt-10 pb-6 sm:pb-8">
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center">
          {/* Text column */}
          <div>
            <span className="inline-flex items-center gap-1.5 text-xs font-medium text-emerald-800 bg-emerald-50 border border-emerald-100 px-3 py-1 rounded-full mb-3 sm:mb-4">
              <MapPin className="w-3 h-3" /> Delivering across Muhanga District
            </span>
            <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl font-semibold text-stone-900 leading-[1.1] mb-3 sm:mb-4">
              AMISERVICE's freshest,
              <br />brought to your door.
            </h1>
            <p className="text-stone-500 text-sm sm:text-base mb-5 sm:mb-6 max-w-sm">
              Groceries, seafood, and ready-made food from your local shop — delivered by Sector and Cell, or ready for pickup.
            </p>
            <div className="flex items-center gap-3 mb-5 sm:mb-8">
              <Link to="/products" className="bg-emerald-900 text-white font-medium px-5 sm:px-6 h-10 sm:h-11 flex items-center rounded-full hover:bg-emerald-800 text-sm">
                Start shopping
              </Link>
              <Link
            ...
            <div className="flex flex-wrap gap-3 sm:gap-5 text-xs text-stone-500">
          ...
          {/* Image column — hidden on small screens to keep the hero clean */}
      ...
      {/* Categories */}
      <section className="max-w-6xl mx-auto px-4 sm:px-5 py-6 sm:py-8">
        <h2 className="font-serif text-lg sm:text-xl font-semibold text-stone-900 mb-0.5 sm:mb-1">Shop by category</h2>
        <p className="text-xs sm:text-sm text-stone-400 mb-4 sm:mb-5">Everything from your shop, organized</p>
        <div
      ...
      {/* Order cutoff banner */}
      <section className="max-w-6xl mx-auto px-4 sm:px-5 py-2">
        <div className="bg-stone-900 rounded-2xl px-4 sm:px-6 py-4 flex items-center gap-3">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-5 py-8 sm:py-10">
        <div className="bg-emerald-900 rounded-2xl p-5 sm:p-6 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 text-white">
      ...
      {/* App teaser (Phase 2) */}
      <section className="max-w-6xl mx-auto px-4 sm:px-5 py-8 sm:py-10">
        <div className="rounded-2xl border border-stone-200 bg-white p-5 sm:p-8 grid md:grid-cols-[1fr_auto] gap-6 sm:gap-8 items-center">
          <div>
            ...
            <h3 className="font-serif text-xl sm:text-2xl font-semibold text-stone-900 mb-2">The AMI SERVICES app</h3>
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-xl bg-stone-100 flex items-center justify-center">
              <QrCode className="w-8 h-8 sm:w-10 sm:h-10 text-stone-300" />
            </div>
      ...
      <footer className="border-t border-stone-200 mt-6">
        <div className="max-w-6xl mx-auto px-4 sm:px-5 py-8 sm:py-10 grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8">
          <div>
